...
public class GaugeRpm extends View {
	...
	public void setDefaultRanges() {		
		mRangeValues = new float[] { 35, 60, 70, 80 };				
		mRangeColors = new int[] {Color.rgb(250, 250, 250), Color.rgb(232, 231, 33), Color.rgb(232, 111, 33), Color.rgb(231, 32, 43) };
	}
	...
	public void setDefaultScaleRangePaints() {
		...
		for (int i = 0; i < length; i++) {
			...
			mRangePaints[i].setTextSize(0.06f);
